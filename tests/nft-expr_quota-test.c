...
static void cmp_nftnl_expr(struct nftnl_expr *rule_a, struct nftnl_expr *rule_b)
{
	if (nftnl_expr_get_u64(rule_a, NFTNL_EXPR_QUOTA_BYTES) !=
	    nftnl_expr_get_u64(rule_b, NFTNL_EXPR_QUOTA_BYTES))
		print_err("Expr NFTNL_EXPR_QUOTA_BYTES mismatches");
